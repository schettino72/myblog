...
BLOG_AUTHOR = "schettino72"  # (translatable)
BLOG_TITLE = "schettino72"  # (translatable)
...
BLOG_DESCRIPTION = "on programming"  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; schettino72 - Powered by <a href="http://getnikola.com">Nikola</a>         {license}'
